        ...
        public static (ArgumentType Type, string Value) ParseUnnamedArgument(ArgumentSyntax argument, int position, IEnumerable<IParameterSymbol> methodParameters)
        {
            ...
            ArgumentType GetArgumentType(IParameterSymbol parameterSymbol)
            {
                switch (parameterSymbol.Type.ToFullName())
                {
                    ...
                    case "Unity.Entities.ComponentType":
                        return ArgumentType.ComponentType;
                    case "Unity.Entities.ComponentTypeSet":
                        return ArgumentType.ComponentTypeSet;
                    case "Unity.Entities.Entity":
                        return ArgumentType.Entity;
                    case "Unity.Entities.EntityArchetype":
                        return ArgumentType.EntityArchetype;
                    case "Unity.Collections.NativeArray<Unity.Entities.Entity>":
                        return ArgumentType.EntitiesNativeArray;
                    case "Unity.Collections.FixedString64Bytes":
